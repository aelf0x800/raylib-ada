...
package Raylib is
   ...
   --//////////////////////////////////////////////////////////////////////////
   -- Custom C interop types
   --//////////////////////////////////////////////////////////////////////////
   subtype C_String is Standard.String
      with Dynamic_Predicate => 
         C_String'Length >= 1 and then C_String (C_String'Last) = Ada.Characters.Latin_1.NUL;
   ...
   procedure Init_Window (Width, Height : int; Title : C_String)
      with
         Import        => true,
         Convention    => C,
   ...
   procedure Set_Window_Title (Title : C_String)
      with
         Import        => true,
         Convention    => C,
   ...
   procedure Set_Clipboard_Text(Text : C_String)
      with
         Import        => true,
         Convention    => C,
   ...
   function Load_Shader (Vs_File_Name, Fs_File_Name : C_String) return Shader
      with
         Import        => true,
         Convention    => C,
         External_Name => "LoadShader";
   -- Load shader from code strings and bind default locations
   function Load_Shader_From_Memory (Vs_Code, Fs_Code : C_String) return Shader
      with
         Import        => true,
         Convention    => C,
   ...
   function Get_Shader_Location
      (Shadr : Shader; Uniform_Name : C_String) return int
      with
         Import        => true,
         Convention    => C,
